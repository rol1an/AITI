...
export const messages = {
  'zh-CN': {
    ...
    home: {
      ...
      visitorCount: '本站已累计 <strong>550W+</strong> 次异世界访问',
      relayButton: '复制测试链接',
      ...
      socialProof: {
        tag: 'Featured By',
        title: '超过 160 万人访问，并被永雏塔菲直播游玩',
        copy: 'ACGTI 已累计获得超过 160 万访问人数、550 万访问量，也曾出现在永雏塔菲的直播内容中。',
        pillA: '160W+ 访问人数',
        pillB: '永雏塔菲直播游玩',
        button: '观看直播录播',
        imageAlt: '永雏塔菲角色立绘',
    ...
    result: {
      ...
      turnstileLabel: '人机验证',
      turnstileLocalHint: '当前未配置 Turnstile，开发环境将自动跳过验证。',
  ...
  'zh-TW': {
    ...
    home: {
      ...
      visitorCount: '本站已累計 <strong>550W+</strong> 次異世界訪問',
      relayButton: '複製測試連結',
      ...
      socialProof: {
        tag: 'Featured By',
        title: '累計超過 160 萬人訪問，並曾由永雛塔菲直播遊玩',
        copy: 'ACGTI 已累計獲得超過 160 萬訪問人數、550 萬訪問量，也曾出現在永雛塔菲的直播內容中。這些真實的傳播記錄，能讓首頁更直接地建立信任感與話題度。',
        pillA: '160W+ 訪問人數',
        pillB: '永雛塔菲直播遊玩',
        button: '觀看直播錄影',
        imageAlt: '永雛塔菲角色立繪',
    ...
    result: {
      ...
      turnstileLabel: '人機驗證',
      turnstileLocalHint: '目前未設定 Turnstile，開發環境將自動跳過驗證。',
  ...
  en: {
    ...
    result: {
      ...
      turnstileLocalHint: 'Turnstile is not configured. Verification is skipped in local development.',
  ...
  ja: {
    ...
    home: {
      ...
      visitorCount: 'すでに <strong>550万+</strong> の異世界からの旅人がテストを行いました',
      ...
      socialProof: {
        tag: 'Featured By',
        title: '累計 160 万人超が訪問し、さらに永雏塔菲の配信でもプレイ',
        copy: 'ACGTI は累計 160 万人を超える訪問者と 550 万回のアクセスを獲得し、永雏塔菲の配信内でも取り上げられました。ホームでこの実績を見せることで、初見ユーザーにも規模感と話題性がすぐ伝わります。',
        pillA: '160万+ 訪問者',
        pillB: '永雏塔菲が配信でプレイ',
        button: '配信アーカイブを見る',
        imageAlt: '永雏塔菲のイラスト',
    ...
    result: {
      ...
      turnstileLabel: '人間確認',
      turnstileLocalHint: 'Turnstile は未設定です。ローカル開発では検証をスキップします。',
