...
export const messages = {
  'zh-CN': {
    ...
    home: {
      ...
      heroTitle: '"终于有人把你看懂了。"',
      heroSubtitle: 'AITI 官网取自 MBTI，是一个专为研究牲打造的人格原型测试。只要做几道情境题，就能测出你是什么大模型，外加一份详细的本命大模型解析。',
      start: '开始测试 / 重新测试 →',
      starProject: '去给项目 Star',
      relayTitle: '如果你觉得这个测试有点意思',
      relayCopy: '欢迎把测试链接顺手转发给朋友、群聊或同好圈。',
      visitorCount: '本站已累计 <strong>600W+</strong> 次人格唤醒',
      relayButton: '复制测试链接',
  ...
  'zh-TW': {
    ...
    home: {
      ...
      visitorCount: '本站已累計 <strong>600W+</strong> 次人格喚醒',
      relayButton: '複製測試連結',
  ...
  en: {
    ...
    home: {
      ...
      visitorCount: 'Over <strong>4.5M+</strong> AI personas awakened',
  ...
  ja: {
    ...
    home: {
      ...
      visitorCount: 'すでに <strong>600万+</strong> 回の AI 人格が目覚めました',
