...
export const messages = {
  'zh-CN': {
    ...
    home: {
      ...
      socialProof: {
        tag: 'Featured By',
        title: '超过 117 万人访问，并被永雏塔菲直播游玩',
        copy: 'ACGTI 已累计获得超过 117 万访问人数、400 万访问量，也曾出现在永雏塔菲的直播内容中。',
        pillA: '117W+ 访问人数',
        pillB: '永雏塔菲直播游玩',
        button: '观看直播录播',
        imageAlt: '永雏塔菲角色立绘',
  ...
  'zh-TW': {
    ...
    home: {
      ...
      visitorCount: '本站已累計 <strong>400W+</strong> 次異世界訪問',
      relayButton: '複製測試連結',
      ...
      socialProof: {
        tag: 'Featured By',
        title: '累計超過 117 萬人訪問，並曾由永雛塔菲直播遊玩',
        copy: 'ACGTI 已累計獲得超過 117 萬訪問人數、400 萬訪問量，也曾出現在永雛塔菲的直播內容中。這些真實的傳播記錄，能讓首頁更直接地建立信任感與話題度。',
        pillA: '117W+ 訪問人數',
        pillB: '永雛塔菲直播遊玩',
        button: '觀看直播錄影',
        imageAlt: '永雛塔菲角色立繪',
  ...
  en: {
    ...
    home: {
      ...
      visitorCount: 'Over <strong>4M+</strong> cross-world travelers have taken the test',
  ...
  ja: {
    ...
    home: {
      ...
      visitorCount: 'すでに <strong>400万+</strong> の異世界からの旅人がテストを行いました',
      ...
      socialProof: {
        tag: 'Featured By',
        title: '累計 117 万超のアクセス、さらに永雏塔菲の配信でもプレイ',
        copy: 'ACGTI は累計 117 万回を超えるアクセスを獲得し、永雏塔菲の配信内でも取り上げられました。ホームでこの実績を見せることで、初見ユーザーにも規模感と話題性がすぐ伝わります。',
        pillA: '117万+ アクセス',
        pillB: '永雏塔菲が配信でプレイ',
        button: '配信アーカイブを見る',
        imageAlt: '永雏塔菲のイラスト',
