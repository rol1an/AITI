...
- **22 位角色匹配** — 涵盖 VOCALOID、EVA、东方Project、孤独摇滚、MyGO、Ave Mujica、原神等作品
...
4. **角色匹配** — 优先展示同 MBTI 类型角色，再补足同原型或高相似度角色，最多展示 5 个
...
| `src/data/characters.json` | 22 个角色条目，包含 MBTI 映射、标签、吐槽文案、六维角色向量 |
