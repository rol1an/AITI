...
export const messages = {
  ...
  en: {
    ...
    result: {
      ...
      personaBasisTip: 'This character has no single official personality basis. The mapping is mainly derived from community depictions, fan works, and franchise-derived impressions, not an official canon personality.',
  ...
  ja: {
    ...
    result: {
      ...
      personaBasisTip: 'このキャラクターには、統一された公式の性格設定がありません。人格マッピングは主にコミュニティの一般的なイメージ、二次創作、企画派生の印象に基づいており、公式の唯一の人格結論ではありません。',
      ossTitle: 'オープンソース',
