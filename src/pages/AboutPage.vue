...
useSeo({
  title: '关于 AITI - AI Type Indicator 模型画像测试 | 项目说明与常见问题',
  description: 'AITI（AI Type Indicator）是以偏好维度为基础的 AI 模型画像测试工具。25 道情境题、14 个模型画像，支持中英日多语言。了解项目定位、当前功能、技术边界与常见问题。',
  path: '/about',
  jsonLd: faqJsonLd,
})
</script>
      ...
      <div class="page-stack">
        <section class="intro-block" v-reveal>
          ...
          <div class="action-wrap">
            <a href="https://github.com/tianxingleo/AITI" target="_blank" rel="noopener noreferrer" class="btn btn-green github-btn">
            ...
            <p class="action-note">
              ...
              <a href="https://github.com/tianxingleo/AITI/issues" target="_blank" rel="noopener noreferrer">{{ t('about.issue') }}</a>
            </p>
          </div>
        </section>
