...
export const messages = {
  'zh-CN': {
    ...
    home: {
      ...
      visitorCount: '本站已累计 <strong>500W+</strong> 次异世界访问',
      relayButton: '复制测试链接',
      ...
      stats: [
        { value: '500W+', label: '访问量（截止至2026.4.15）', color: '#4899a3' },
      ...
      socialProof: {
        tag: 'Featured By',
        title: '超过 141 万人访问，并被永雏塔菲直播游玩',
        copy: 'ACGTI 已累计获得超过 141 万访问人数、500 万访问量，也曾出现在永雏塔菲的直播内容中。',
        pillA: '141W+ 访问人数',
        pillB: '永雏塔菲直播游玩',
        button: '观看直播录播',
        imageAlt: '永雏塔菲角色立绘',
  ...
  'zh-TW': {
    ...
    home: {
      ...
      visitorCount: '本站已累計 <strong>500W+</strong> 次異世界訪問',
      relayButton: '複製測試連結',
      ...
      stats: [
        { value: '500W+', label: '訪問量（截止至2026.4.15）', color: '#4899a3' },
      ...
      socialProof: {
        tag: 'Featured By',
        title: '累計超過 141 萬人訪問，並曾由永雛塔菲直播遊玩',
        copy: 'ACGTI 已累計獲得超過 141 萬訪問人數、500 萬訪問量，也曾出現在永雛塔菲的直播內容中。這些真實的傳播記錄，能讓首頁更直接地建立信任感與話題度。',
        pillA: '141W+ 訪問人數',
        pillB: '永雛塔菲直播遊玩',
        button: '觀看直播錄影',
        imageAlt: '永雛塔菲角色立繪',
  ...
  ja: {
    ...
    home: {
      ...
      visitorCount: 'すでに <strong>500万+</strong> の異世界からの旅人がテストを行いました',
      ...
      stats: [
        { value: '500万+', label: '累計アクセス', color: '#4899a3' },
      ...
      socialProof: {
        tag: 'Featured By',
        title: '累計 141 万人超が訪問し、さらに永雏塔菲の配信でもプレイ',
        copy: 'ACGTI は累計 141 万人を超える訪問者と 500 万回のアクセスを獲得し、永雏塔菲の配信内でも取り上げられました。ホームでこの実績を見せることで、初見ユーザーにも規模感と話題性がすぐ伝わります。',
        pillA: '141万+ 訪問者',
        pillB: '永雏塔菲が配信でプレイ',
        button: '配信アーカイブを見る',
        imageAlt: '永雏塔菲のイラスト',
