  ...
  <div class="site-shell">
    <header class="site-header">
      <RouterLink class="brand-lockup" to="/">
        ...
        <span class="brand-name">AITI</span>
      </RouterLink>
      ...
      <nav class="site-nav" :class="{ 'is-open': isNavOpen }" @click="handleNavClick">
        <a href="https://github.com/rol1an/AITI" target="_blank" rel="noopener noreferrer" style="display: inline-flex; align-items: center; gap: 4px; color: #333e49; font-weight: 600; text-decoration: none;" :title="t('app.nav.githubTitle')">
        ...
        <a href="https://github.com/rol1an/AITI/discussions" target="_blank" rel="noopener noreferrer" class="nav-external-link">{{ t('app.nav.community') }}</a>
    ...
    <footer v-if="showFooter" class="site-footer">
      <div class="footer-content">
        ...
        <div class="footer-section">
          ...
          <a href="https://github.com/rol1an/AITI" target="_blank" rel="noopener noreferrer" class="footer-link cta-star" style="display: inline-flex; align-items: center; gap: 6px; font-weight: 600; color: #3ba17c; margin-top: 4px;">
          ...
          <p class="footer-note" style="margin-top: 8px;">
            ...
            <a href="https://github.com/rol1an/AITI/issues" target="_blank" rel="noopener noreferrer" style="color: #3ba17c; font-weight: 700; text-decoration: none;">{{ t('app.footer.notes.issue') }}</a>
          </p>
        </div>
        <div class="footer-section">
      ...
      <div class="footer-bottom">
        <p class="footer-copyright">© 2026 AITI Project</p>
