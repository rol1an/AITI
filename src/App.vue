...
const authorSocialLinks: AuthorSocialLink[] = [
  {
    ...
    viewBox: '0 0 24 30',
    paths: [
      'M23.5 7.8c.3.1.5.5.5.8v12.7c0 .3-.2.7-.5.8l-3.8 2.2c-.3.2-.5 0-.5-.3V11.7c0-.3-.2-.7-.5-.8l-3.8-2.2c-.3-.2-.5 0-.5.3V12c0 .3-.2.5-.6.5h-3.7c-.3 0-.5-.2-.5-.5V.3c0-.3.2-.4.5-.3l1.4.8c.3.2.5.4.5.4s.2.1.5.3ZM9.6 17.9c0-.3.2-.5.5-.5h3.7c.3 0 .5.2.6.5v11.7c0 .3-.2.4-.5.3l-4.7-2.7c-.2-.1-.4-.2-.4-.2s-.2-.1-.5-.3L.5 22.2c-.3-.2-.5-.5-.5-.8V8.6c0-.3.2-.7.5-.8l3.8-2.2c.3-.2.5 0 .5.3v12.5c0 .3.2.7.5.8l3.8 2.2c.3.2.5 0 .5-.3Z',
    ],
  },
  {
    label: '哔哩哔哩',
          ...
          <div class="author-social-list">
            ...
            >
              <span class="author-social-icon" aria-hidden="true">
                <svg :viewBox="social.viewBox" fill="currentColor">
